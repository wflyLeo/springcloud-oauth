package com.uooguo.newretail.cloud.framework.storage;


import com.aliyun.oss.OSSClient;
import com.uooguo.newretail.cloud.framework.storage.config.LocalStorageProperties;
import com.uooguo.newretail.cloud.framework.storage.config.OssProperties;
import com.uooguo.newretail.cloud.framework.storage.impl.AliyunFileStorage;
import com.uooguo.newretail.cloud.framework.storage.impl.LocalFileStorage;
...
public class StorageAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "newretail.storage", name = "type", havingValue = "aliyun" )
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "newretail.storage", name = "type", havingValue = "local" )
    @ConditionalOnMissingBean(FileStorage.class)
    @Order(1)
