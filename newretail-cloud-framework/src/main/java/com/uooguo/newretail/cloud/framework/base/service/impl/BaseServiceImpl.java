package com.uooguo.newretail.cloud.framework.base.service.impl;
...
import com.uooguo.newretail.cloud.framework.base.pagination.PageableCriteria;
import com.uooguo.newretail.cloud.framework.base.service.BaseService;
import com.uooguo.newretail.cloud.framework.criteria.Criteria;
import com.uooguo.newretail.cloud.framework.criteria.parser.CriteriaParser;
...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    //引入mybatisplus 2.3后加的
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean updateForSet(String setStr, Wrapper<T> wrapper) {
        return retBool(mapper.updateForSet(setStr, wrapper));
    }
